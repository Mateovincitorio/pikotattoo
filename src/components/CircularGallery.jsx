...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: `https://picsum.photos/seed/1/800/600?grayscale`, text: 'Tatuaje 1' },
      { image: `https://picsum.photos/seed/2/800/600?grayscale`, text: 'Tatuaje 2' },
      { image: `https://picsum.photos/seed/3/800/600?grayscale`, text: 'Tatuaje 3' },
      { image: `https://picsum.photos/seed/4/800/600?grayscale`, text: 'Tatuaje 4' },
      { image: `https://picsum.photos/seed/5/800/600?grayscale`, text: 'Tatuaje 5' },
      { image: `https://picsum.photos/seed/6/800/600?grayscale`, text: 'Tatuaje 6' }
    ];
...
export default function CircularGallery({
  ...
  return <div className="circular-gallery" ref={containerRef} id='Galeria' />;
}
